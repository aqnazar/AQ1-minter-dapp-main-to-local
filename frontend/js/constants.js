const contractAddress = "0xb638d9d854d1E3929F65C91762BDF5A6E90bad40"; //Replace with your own contract address
const chain = 'polygon'; // rinkeby or polygon

const welcome_h1 = "PUT ON YOUR STARE FACE";
const welcome_h2 = "NO INFLATED VALUE. ONLY SUBJECTIVE.";
const welcome_p = "STARE FACE is for everyone. No speculatively inflated trash. YOU pay for what YOU get. Simple PICTURES for all PERSONALITIES. Use them however you want. Only 12 MATIC per PICTURE." ;
...
const p_presale_coming_soon = "The news are coming";
...
const p_public_mint = "NO WHITELIST";
const button_presale_coming_soon = "Get on the Whitelist";
const button_presale_mint_whitelisted = "Mint Your STARE FACE";
const button_presale_mint_not_whitelisted = "Get on the Whitelist";
const button_presale_already_minted = "JOIN";
const button_public_mint = "Mint Your STARE FACE";
